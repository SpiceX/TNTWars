...
class BossBar extends Vector3
{
	...
	/**
	 * Updates the bossbar for all viewers
	 */
	 ...
	 * @param string $title
	 */
	public function updateFor(Player $player, $title = ''): void
	{
	 ...
	 * @param string $title
	 */
	public function setTitleFrom(Player $player, string $title): void
	{
		$this->updateFor($player, $title);
	}
